(ns acme.styles.layout.mini-classes
  (:require [acme.styles.core :refer [light-grey px size-0 size-minus-1 size-minus-2 size-minus-3 size-minus-4 size-plus-1 size-plus-2 size-plus-3 size-plus-4 size-plus-5]]))
...
(def screen
  (list
   ...
   [:.text-inliner {:align-items "baseline"
                    :display "flex"
                    :gap size-minus-4}]
   ...
   [:.flex-align-center-center {:display "flex"
                                :align-items "center"
                                :justify-content "center"}]

   (for [[size unit] {:minus-4 size-minus-4
