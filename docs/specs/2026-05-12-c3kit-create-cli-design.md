...
**Parent spec:** [`2026-05-12-c3kit-starter-roadmap-design.md`](2026-05-12-c3kit-starter-roadmap-design.md)
...
3. Default: `git clone --depth 1 --branch <ref> https://github.com/cleancoders/c3kit-starter <tmp>/c3kit-starter`. Ref defaults to the tag baked into the CLI binary at build time; override with `--template-ref <ref>`.
...
**Remote mode (3):** clone monorepo into `<tmp>/c3kit-starter/`, copy out `templates/<id>/`, delete `<tmp>/c3kit-starter/` regardless of outcome.
...
1. GET `https://api.github.com/repos/cleancoders/c3kit-starter/releases/latest`, parse tag.
